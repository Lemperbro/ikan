...
@section('container')
<div class="relative ml-60  pt-6 ">
        <h1 class="text-main3 font-semibold text-2xl">Lebam</h1>
        <p class="text-main3">Lebam atau lelang bandeng mujair adalah sistem penjualan bandeng mujair dengan metode lelang</p>
        ...
        <a href="" class="px-2 pt-2 pb-4 bg-main4 rounded-md">
            ...
            <p class="font-semibold text-main2 mt-2">Buka Harga</p>
